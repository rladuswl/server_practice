...
public class UserDao {
    ...
    public int createUser(PostUserReq postUserReq){
        String createUserQuery = "insert into User (name, nickName, birth, email, pwd) VALUES (?,?,?,?,?)";
        Object[] createUserParams = new Object[]{postUserReq.getName(), postUserReq.getNickName(),postUserReq.getBirth(), postUserReq.getEmail(), postUserReq.getPassword()};
